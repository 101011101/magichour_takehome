...
- Product shots do cost more than they need to. The pipeline still runs its person-side step on them, repainting a few percent of the garment for no visible benefit. Preparing a product garment could later skip that step and save one model call per garment; nothing in the product needs to change for it, and quality did not depend on it either way.
