...
| 10 | Comparison page in `v2/artifacts/`, generated by a script in `v2/build/`; then the parity re-run on downloaded weights before any number is called final. | 8 | `v2/artifacts/artifact_repair.html` |
