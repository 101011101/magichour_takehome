...
| **v3.4 — open** | what is left after v3.3, and which side of the edit is it on? Person-side clothing leak (F1), skirt→trousers on the wearer (F2), reference drift (F3). [experiment](v3.4/EXPERIMENT.md) |
