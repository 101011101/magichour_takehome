...
G3_COLS = [
    ...
    ("shipped + SeedVR2", "harness pick, realism pass"),
]
...
G3_ROWS = [
    ...
    ("HD_p028+dualuse_navy_peacoat_onmodel", None,
     "the one shipped fail - router chose PHEAD at hair 11.9%, gate silent",
     {"PHEAD": ("fail", "fail"), "QX_qwen_p1": ("perfect", "perfect"),
      "after": ("fail", "ships fail")}),
]
...
(v223_perfect_tier_picks.csv). The last column is the harness pick after the
SeedVR2 realism pass.</div>
{grid3()}
